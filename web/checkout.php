   ...
   <div class="cart-bottom">
   	 	     ...
   	 	     <tr class="cake-top">
 	     	    ...
 	     	    <td class="quantity"> 	 	     	 
   	 	     	  <div class="product-right">
   	 	     	  	 <input min="1" type="number" id="quantity" name="quantity" value="1" class="form-control input-small" readonly="readonly">				  
   	 	     	  </div>
   	 	     	</td>
   	 	     	<td class="price">
   	 	     		<h4>$12.99</h4>	 	     		
   	 ...
   	 <div class="vocher">
   	 	...
   	 	<div class="dis-total">
   	 		<h1>Total $38.97</h1>
   	 		<div class="tot-btn">
   	 			<a class="shop" href="cart.php">Back to Cart</a>
   	 			<a class="check" href="#">Proceed to Pay</a>
   	 		</div>
   	 	</div>
   	   <div class="clear"> </div>
   	 </div>
